// Imported from [[w:User:Alex Smotrov/edittop.js]], version as of: 2007-06-19T04:28:52
// Updated from [[w:User:TheDJ/Gadget-edittop.js]], version as of: 2009-04-28T11:54:22
  ...
  $(function edittop_hook () {
    ...
    span0.find("a").each(function (idx) {
      ...
      if ( !/&(ve|)section=T/.test( href ) ) { // not transcluded
        a.attr( "href", href.replace( /&(ve|)section=\d+/, "&$1section=0&summary=/*%20đầu%20*/%20" ) );
      } else if ( /&vesection=/.test( href ) ) { // transcluded, VE
        a.attr( "href", mw.util.getUrl( mw.config.get( 'wgPageName' ) ) + "?veaction=edit&vesection=0&summary=/*%20đầu%20*/%20" );
      } else { // transcluded, not VE
        a.attr( "href", mw.util.getUrl( mw.config.get( 'wgPageName' ) ) + "?action=edit&section=0&summary=/*%20đầu%20*/%20" );
      }
    });
  });
}
