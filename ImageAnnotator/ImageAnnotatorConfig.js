...
/*
  ...
  Author: [[w:User:Lupo]], September 2009
...
(function () {
  ...
  var config = {
    ...
    UI : {
      ...
      defaults: {
         wpImageAnnotatorDelete        : 'Xóa'
        ,wpImageAnnotatorEdit          : 'Sửa đổi'
        ,wpImageAnnotatorSave          : 'Lưu'
        ,wpImageAnnotatorCancel        : 'Đóng'
        ,wpImageAnnotatorPreview       : 'Xem trước'
        ,wpImageAnnotatorRevert        : 'Lùi lại'
        ,wpTranslate                   : 'biên dịch'
        ,wpImageAnnotatorAddButtonText : 'Thêm ghi chú'
        ,wpImageAnnotatorAddSummary    :
          '[[c:MediaWiki talk:Gadget-ImageAnnotator.js|Adding image note]]$1'
        ,wpImageAnnotatorChangeSummary :
          '[[c:MediaWiki talk:Gadget-ImageAnnotator.js|Changing image note]]$1'
        ,wpImageAnnotatorRemoveSummary :
          '[[c:MediaWiki talk:Gadget-ImageAnnotator.js|Removing image note]]$1'
        ,wpImageAnnotatorHasNotesShort : 'This file has annotations.'
        ,wpImageAnnotatorHasNotesMsg   :
           'Tập tin này có ghi chú. Di chuyển con trỏ chuột lên hình ảnh để xem chúng.'
        ,wpImageAnnotatorEditNotesMsg  :
           '<span>\xa0Để sửa đổi ghi chú, hãy truy cập trang <a href="#">x</a>.</span>'
        ,wpImageAnnotatorDrawRectMsg   :
           'Vẽ một hình chữ nhật lên hình ảnh phía trên (nhấn nút chuột trái, sau đó kéo và thả).'
        ,wpImageAnnotatorEditorLabel   :
           '<span>Text of the note (may include '
         + '<a href="//blutigeskareuz.miraheze.org/wiki/Tr%E1%BB%A3_gi%C3%BAp:M%C3%A3_wiki">Wiki markup</a>)</span>'
        ...
        ,wpImageAnnotatorIndicatorIcon :
           '<span>'
         + '<img src="//static.wikitide.net/blutigeskareuzwiki/2/20/Info_Button.webp" '
         + 'width="14" height="14" title="Tập tin này có ghi chú" />'
         + '</span>'
